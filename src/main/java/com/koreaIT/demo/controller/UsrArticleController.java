...
public class UsrArticleController {
	...
	public ResultData<Article> doAdd(HttpSession httpsession, String title, String body) {
		...
		return ResultData.from("S-1", Util.f("%d번 게시물이 생성되었습니다", id),"게시물",articleService.getArticleById(id));
	}
	...
	public ResultData<Article> getArticle(int id) {
		...
		return ResultData.from("S-1", Util.f("%d번 게시물 입니다", id),"게시물", article);
	}
	...
	public ResultData<List<Article>> getArticles() {
		...
		return ResultData.from("S-1", "게시물 리스트","게시물들", articleService.getArticles());
	}
